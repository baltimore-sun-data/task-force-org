var dataproject = {
    ...
    share: function() {
        $(".fa-twitter").on("click", function() {
            var tweet = "Keep up-to-date with this overview of the Baltimore police racketeering cases.";
            var url = "http://data.baltimoresun.com/news/gun-trace-overview/";
        ...
        $(".fa-facebook").on("click", function() {
            var picture = "http://data.baltimoresun.com/news/gun-trace-overview/images/thumb.jpg";
            var title = "Gun Trace Task Force Overview";
            var description = "Keep up-to-date with this overview of the Baltimore police racketeering cases.";
            var url = "http://data.baltimoresun.com/news/gun-trace-overview/";
